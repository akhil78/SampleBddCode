...
public class Configure {
    ...
    private String petClinicUsername;
    private String petClinicPassword;
    ...
    public Configure() {
        ...
        String envUsername = System.getProperty("PC_USERNAME");
        if (envUsername == null)
        {
            envUsername = prop.getProperty("spring.petclinic.username");
        }
        String envPassword = System.getProperty("PC_PASSWORD");
        if (envPassword == null)
        {
            envPassword = prop.getProperty("spring.petclinic.password");
        }
        ...
        setPetClinicUsername(envUsername);
        setPetClinicPassword(envPassword);
    ...
    /**
     * @return the PetClinicUsername
     */
    public String getPetClinicUsername() {
        return petClinicUsername;
    }
    /**
     * @return the PetClinicPassword
     */
    public String getPetClinicPassword() {
        return petClinicPassword;
    }
    /**
    ...
    /**
     * @param petClinicUsername the petClinicUsername to set
     */
    public void setPetClinicUsername(String petClinicUsername) {
        this.petClinicUsername = petClinicUsername;
    }

    /**
     * @param petClinicPassword the petClinicPassword to set
     */
    public void setPetClinicPassword(String petClinicPassword) {
        this.petClinicPassword = petClinicPassword;
    }
